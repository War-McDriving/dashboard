...
data = pd.DataFrame({
    'latitude': [
        51.2194, 51.2194, 51.2194, 51.2200, 51.2180, 51.2210, 51.2175, 51.2068527, 51.1794946
    ],
    'longitude': [
        4.4025, 4.4025, 4.4025, 4.4030, 4.4010, 4.4040, 4.4005, 4.4298909, 4.3617847
    ],
    'signal_strength': [
        -70, -68, -65, -60, -75, -55, -80, 60, 100
    ]
})
